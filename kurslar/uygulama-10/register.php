...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if($_POST["password"] != $_POST["repassword"]){
            $repasswordErr="parola eşleşmiyor tekrar alanı.";
        } else{
    ...
    <div class="row">
        <div class="col-12">
            <form action="register.php" method="post">
                <div class="mb-3">
                    <label form="username">Kullanıcı Adı</label>
                    <input type="text" name="username" class="form-control" value="<?php echo $username;?>">
                    <div class="text-danger"><?php echo $usernameErr; ?></div>
                </div>
                <div class="mb-3">
                    <label form="email">Eposta</label>
                    <input type="email" name="email" class="form-control" value="<?php echo $email;?>">
                    <div class="text-danger"><?php echo $emailErr; ?></div>
                </div>
                <div class="mb-3">
                    <label form="password">Parola</label>
                    <input type="password" name="password" class="form-control" value="<?php echo $password;?>">
                    <div class="text-danger"><?php echo $passwordErr; ?></div>
                </div>
                <div class="mb-3">
                    <label form="repassword">Parola Tekar</label>
                    <input type="password" name="repassword" class="form-control">
                    <div class="text-danger"><?php echo $repasswordErr; ?></div>
                </div>
                <div class="mb-3">
                    <label form="city">Şehir</label>
                ...
                <div class="mb-3">
                    ...
                    <?php foreach($hobiler as $id=> $hobi):?>
                        <div class="from-check">
                            ...
                            >
                            <label for="hobbies_<?php echo $id;?>" class="from-check-label"><?php echo $hobi;?></label>
                        </div>
                    <?php endforeach;?>
